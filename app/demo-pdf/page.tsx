...
import { FileText, Palette, Smartphone, Shield, Zap, CheckCircle, Star, Download, Eye } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Gerador de PDF Moderno</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Sistema avançado de geração de PDFs com cores vibrantes, links clicáveis para WhatsApp, layout responsivo e
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
            ...
            {demoOptions.map((option) => (
              <button
                ...
                className={`p-4 rounded-lg border-2 transition-all ${
                  selectedDemo === option.id ? "border-blue-500 bg-blue-50" : "border-gray-200 hover:border-gray-300"
                }`}
              >
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            <a
              href="/api/make-pdf?url=/demo-pdf&fileName=relatorio-demo.pdf&inline=true"
              target="_blank"
        ...
        <div className="text-center py-8 border-t border-gray-200">
          <p className="text-gray-600">Gerador de PDF Moderno v2.0.0 - Desenvolvido com React, TypeScript e PDFKit</p>
